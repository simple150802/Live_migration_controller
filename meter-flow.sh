...
# FLow for meter 1
sudo ovs-ofctl add-flow s1 -O OpenFlow13 priority=200,table=1,in_port=1,ip,tcp,tcp_dst=1000,actions=meter:1,output:2
sudo ovs-ofctl add-flow s1 -O OpenFlow13 priority=200,table=1,in_port=2,ip,tcp,tcp_src=1000,actions=meter:1,output:1

sudo ovs-ofctl add-flow s1 -O OpenFlow13 priority=200,table=1,in_port=1,ip,udp,udp_dst=1000,actions=meter:1,output:2
sudo ovs-ofctl add-flow s1 -O OpenFlow13 priority=200,table=1,in_port=2,ip,udp,udp_src=1000,actions=meter:1,output:1

# Flow for meter 2
sudo ovs-ofctl add-flow s1 -O OpenFlow13 priority=200,table=1,in_port=1,ip,tcp,tcp_dst=2000,actions=meter:2,output:2
sudo ovs-ofctl add-flow s1 -O OpenFlow13 priority=200,table=1,in_port=2,ip,tcp,tcp_src=2000,actions=meter:2,output:1
sudo ovs-ofctl add-flow s1 -O OpenFlow13 priority=200,table=1,in_port=1,ip,udp,udp_dst=2000,actions=meter:2,output:2
...
# Flow for BE traffic
sudo ovs-ofctl add-flow s1 -O OpenFlow13 priority=100,table=1,in_port=1,actions=meter:1000,output:2
sudo ovs-ofctl add-flow s1 -O OpenFlow13 priority=100,table=1,in_port=2,actions=meter:1000,output:1
